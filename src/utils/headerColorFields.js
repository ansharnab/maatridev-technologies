...
export const HEADER_COLOR_GROUPS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "headerBrandTextOnLight", label: "17. Brand title (light bar)", default: "#1a2b3c" },
      { key: "headerBrandSubtextOnLight", label: "18. Brand subtitle (light bar)", default: "rgba(26, 43, 60, 0.72)" },
      { key: "logoColorPrimary", label: "19. Logo icon primary", default: "#007cc3" },
      { key: "logoColorAccent", label: "20. Logo icon accent", default: "#00b8a9" },
      { key: "logoImageFilter", label: "21. Logo tone preset", default: "none", type: "logoFilter" },
      { key: "headerLogoWordmarkFilter", label: "22. Logo custom CSS filter", default: "none", type: "text" },
    ],
  },
  {
    id: "cta",
    label: "CTA button (4)",
    fields: [
      { key: "headerCtaBg", label: "23. Button background", default: "#007cc3" },
      { key: "headerCtaColor", label: "24. Button text", default: "#ffffff" },
      { key: "headerCtaHoverBg", label: "25. Button hover background", default: "#006aa8" },
      { key: "headerCtaBorderColor", label: "26. Button border", default: "#007cc3" },
    ],
  },
  {
    id: "mobile",
    label: "Mobile menu (3)",
    fields: [
      { key: "headerToggleBg", label: "27. Hamburger background", default: "rgba(255, 255, 255, 0.1)" },
      { key: "headerToggleBorderColor", label: "28. Hamburger border", default: "rgba(255, 255, 255, 0.25)" },
      { key: "headerToggleIconColor", label: "29. Hamburger icon lines", default: "#ffffff" },
    ],
  },
  {
    id: "preview",
    ...
    fields: [
      { key: "headerPreviewHomeBg", label: "30. Preview: home hero behind header", default: "linear-gradient(125deg, #0a1628, #003d5c, #004d73)", type: "gradient" },
      { key: "headerPreviewPageBg", label: "31. Preview: page banner behind header", default: "linear-gradient(135deg, #007cc3, #003d5c)", type: "gradient" },
    ],
  },
];
