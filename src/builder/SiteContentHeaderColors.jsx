...
export default function SiteContentHeaderColors({ settings = {}, onPatch }) {
  ...
  return (
    <section className="scp-section-card scp-header-text-colors">
      <h4>Menu &amp; brand text</h4>
      <p className="scp-header-themes__intro">
        Header link and brand title colors. For the appointment button, use the section above.
      </p>
      ...
      {SITE_CONTENT_HEADER_COLOR_UI.filter((g) => g.id !== "cta").map((group) => (
